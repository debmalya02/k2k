...
//   // Use another useEffect to log productDetails after the state is updated
//   useEffect(() => {
//     if (productDetails) {
...
//         <h1 className="text-xl font-semibold">{productDetails?.productName || 'Product Name'}</h1>
//       </div>
//       <div className="bg-gray-300 p-4 rounded-md mb-6 text-center">
//         <p>{productDetails?.productDetails || 'Product Details'}</p>
//       </div>
